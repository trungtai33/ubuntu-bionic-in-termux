...
yes | apt install -y proot > /dev/null 2>&1
...
printf "\n\e[34m[\e[32m*\e[34m]\e[36m Installing Ubuntu Bionic, please wait...\n\e[31m"
...
Linux version 5.4.0 (termux@ubuntu) (gcc version 4.9 (GCC)) $(uname -v)
EOF
bin="start-ubuntu-bionic"
